...
func I3[T any](db *gorm.DB, opts ...clause.Expression) _I3Interface[T] {
	return _I3Impl[T]{
		Interface: gorm.G[T](db, opts...),
	}
}

type _I3Interface[T any] interface {
	gorm.Interface[T]
	ByID3(ctx context.Context, id int) (T, error)
}

type _I3Impl[T any] struct {
	gorm.Interface[T]
}

func (e _I3Impl[T]) ByID3(ctx context.Context, id int) (T, error) {
	var sb strings.Builder
	params := make([]any, 0, 2)
